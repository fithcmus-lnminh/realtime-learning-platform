      ...
      <div className="home__container">
          ...
          <div className="news__card">
            ...
            <div className="news__detail">
              <div className="news__title">
                Thanksgiving ideas: 5 ways to have an awesome Thanksgiving with
                Kahoot!
              </div>
              <div className="news__description">
                Whether you’re celebrating Thanksgiving or simply reflecting on
                what you’re grateful for, here are some ideas to ensure full
                hearts (and bellies!) when celebrating Thanksgiving with your
                loved ones, colleagues, or students!
              </div>
            </div>
          </div>
          <div className="news__card">
            ...
            <div className="news__detail">
              ...
              <div className="news__description">
                Disguise content learning in a game-oriented, student-centered
                dynamic with all new game modes on Kahoot!
              </div>
            </div>
          </div>
        </div>
        <div className="news__card-container">
          ...
          <div className="news__card">
            ...
            <div className="news__detail">
              <div className="news__title">
                Student-centered learning was front and center at the Kahoot!
                EDU Fall Meetup 2022
              </div>
              <div className="news__description">
                Teachers from around the world gathered yesterday to learn about
                new approaches to student-centered learning from shared teacher
                stories, Kahoot! ambassadors, and new Kahoot! feature demos!
              </div>
            </div>
          </div>
        </div>
        <div className="news__card-container">
          <div className="news__card">
            ...
            <div className="news__detail">
              <div className="news__title">
                ISTE 2022 Recap: Why teachers from around the world were buzzing
                about Kahoot!
              </div>
              <div className="news__description">
                Thousands of teachers gathered at the Kahoot! booth to check out
                all the latest features and learn how they can make this the
                ultimate back-to-school season!
              </div>
            </div>
          </div>
          <div className="news__card">
        ...
        <div className="news__card-container">
          <div className="news__card">
            ...
            <div className="news__detail">
              ...
              <div className="news__description">
                Help students feel empowered as they grow real-world personal
                finance skills with this new collection of compelling kahoots
                from Intuit, now available to play for free on Kahoot!.
              </div>
            </div>
          </div>
          <div className="news__card">
            ...
            <div className="news__detail">
              <div className="news__title">
                Teacher Takeover: Submarine squad for content, collaboration,
                and celebration!
              </div>
              <div className="news__description">
          ...
          <div className="news__card">
            ...
            <div className="news__detail">
              ...
              <div className="news__description">
                ...
                Discover how engaging solutions for knowledge sharing can help
                companies empower employees and build thriving workplaces.
              </div>
            </div>
          </div>
          <div className="news__card">
            ...
            <div className="news__detail">
              <div className="news__title">
                Kahoot! announces Q3 record performance, with strong momentum
                across all user segments, and powerful line-up for 2023
              </div>
              <div className="news__description">
                With the ever-growing need for digital learning in school, work
                and home, Kahoot! delivers a strong quarter on the heels of a
                successful 2022 Back to School and Back to Work season.
              </div>
            </div>
          </div>
        </div>
